...
const ResetPassword = () => {
  ...
  const generateOtp = async () => {
    try {
      ...
      const response = await axios.post("https://military-asset-be.onrender.com/user/otp", { username });
  ...
  const validateOtp = async () => {
    try {
      ...
      const response = await axios.post("https://military-asset-be.onrender.com/user/otpverify", { username, otp: password });
